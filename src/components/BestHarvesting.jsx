...
const BestHarvesting = () => {
  ...
  const items = [
    {
      image: <i class="fa-solid fa-leaf"></i>,
      title: "CEREALS",
      description:
        "Integer sit amet mattis quam, sit amet ul tricies velit. Praesent ullam corper dui turpis dolor sit amet quam.",
    },
    {
      image: <i class="fa-brands fa-apple"></i>,
      title: "FRUITS & BERRIES",
      description:
        "Integer sit amet mattis quam, sit amet ul tricies velit. Praesent ullam corper dui turpis dolor sit amet quam.",
    },
    {
      image: <i class="fa-brands fa-pagelines"></i>,
      title: "VEGETABLES",
      description:
        "Integer sit amet mattis quam, sit amet ul tricies velit. Praesent ullam corper dui turpis dolor sit amet quam.",
    },
    ...
    <section className={styles.bestHarvesting}>
      <div className="container">
        <div className={styles.bestHarvesting__titleBlock}>
          <SectionHeading
            title={"Best Harvesting Agriculture Company"}
            color={"#323648"}
          />
          <p>{description}</p>
        </div>
        <div className={styles.bestHarvesting__contentBlock}>
          <FlexContainer>
            {items.map((item) => (
              <ContentBlockItem item={item} type="bestItem" />
            ))}
          </FlexContainer>
        </div>
      </div>
